...
Run the Understanding Check defined by the [canonical understanding protocol](../../docs/protocol/understanding-protocol.md). Selecting this skill requests that checkpoint rather than the shared entry point's default debrief.
