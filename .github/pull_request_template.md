...
Describe the user problem and the scope of this change.

## Changes and evidence

Summarize behavior changes and the commands/results actually observed. Distinguish automated checks from real host sessions. List anything not tested.
